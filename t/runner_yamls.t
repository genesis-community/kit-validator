...
EOS
	my $out = Kit::Validator::Runner::_normalize_yamls_output($input);
...
subtest '_diff_yamls: identical input returns empty string' => sub {
	my $t = "bosh/<VERSION>: a\n     local: b\n";
	is Kit::Validator::Runner::_diff_yamls($t, $t), '',
...
subtest '_diff_yamls: added line surfaces in diff' => sub {
	...
	my $d = Kit::Validator::Runner::_diff_yamls($actual, $expected);
