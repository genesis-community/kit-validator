...
# Genesis::Kit::Validator::Spec's sandbox setup requires a Genesis lib >= a
...
use_ok 'Genesis::Kit::Validator::Spec';

my $min = Genesis::Kit::Validator::Spec::MIN_GENESIS_VERSION();
...
subtest '_check_genesis_version: too old bails with actionable message' => sub {
	...
	eval { Genesis::Kit::Validator::Spec::_check_genesis_version() };
	my $err = $@;
